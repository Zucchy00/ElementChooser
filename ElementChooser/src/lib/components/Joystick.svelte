...
var JoyStick = (function(parameters: any, callback: any, classname: string)
{
    ...
    function buildJoystick() {
        ...
        title = (typeof parameters.title === "undefined" ? "joystick" : parameters.title),
            ...
            if(window.innerWidth / 6.4 < width) {
...
onMount(()=>{
    createJoystick("float-right hover:cursor-pointer aspect-square m-8") //"float-right hover:cursor-pointer ring-2 aspect-square ring-gray dark:ring-white-gray rounded-3xl m-8"
